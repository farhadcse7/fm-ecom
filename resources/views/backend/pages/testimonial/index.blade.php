...
{{-- pushed into style and script inc folder file --}}
@push('admin_style')
                    ...
                    <tbody>
                        @foreach ($testimonials as $testimonial)
                            <tr>
                                ...
                                <td> <img src="{{ asset('uploads/testimonials') }}/{{ $testimonial->client_image }}" alt="" class="img-fluid rounded-circle"></td>
